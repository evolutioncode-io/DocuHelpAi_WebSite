        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={card.step} className="relative">
              ...
              >
                <div className="absolute -top-6 -right-6 bg-white text-amber-600 w-16 h-16 rounded-full flex items-center justify-center text-3xl font-bold shadow-lg text-center">
                  {card.step}
                </div>
                <div className="mb-6">
        ...
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to={getLocalizedRoute('contact')}>
              <button className="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-10 py-5 rounded-xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 transition-all duration-200 font-bold text-lg">
                {t('cta.buttonPrimary')}
              </button>
            </Link>
            <Link to={getLocalizedRoute('contact')}>
              <button className="border-2 border-white text-white px-10 py-5 rounded-xl hover:bg-white hover:text-amber-600 transition-all duration-200 font-bold text-lg">
