          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="#" className="text-white/75 hover:text-white transition-colors" aria-label="Twitter">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to={getLocalizedRoute('security')} className="text-white/75 hover:text-white transition-colors">
                    {t('footer.security')}
                  </Link>
                </li>
              </ul>
