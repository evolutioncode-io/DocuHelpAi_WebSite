...
const routeMappings = {
  en: {
    home: '/',
    product: '/product',
    legalHelpAiNotaries: '/documentoiq-notaries',
    legalHelpAiBanking: '/documentoiq-banking',
    ...
    blog05Procedure: '/blog/how-documentoiq-is-transforming-legal-document-processing',
  ...
  es: {
    home: '/es/',
    product: '/es/producto',
    legalHelpAiNotaries: '/es/documentoiq-notarias',
    legalHelpAiBanking: '/es/documentoiq-banca',
    howWeWork: '/es/how-we-work',
    ...
    blog05Procedure: '/es/blog/como-documentoiq-esta-transformando-el-procesamiento-de-documentos-legales',
  ...
  'pt-BR': {
    ...
    legalHelpAiNotaries: '/pt-br/documentoiq-notarios',
    legalHelpAiBanking: '/pt-br/documentoiq-bancario',
    howWeWork: '/pt-br/how-we-work',
    ...
    blog05Procedure: '/pt-br/blog/como-o-documentoiq-esta-transformando-o-processamento-de-documentos-juridicos',
